...
export default function Home() {
  try {
    ...
    // Add error logging for auth context
    ...
    // Add logging for auth state
    console.log('Auth state:', { user, isBanned, banInfo, isLocked, lockInfo });
    ...
    console.error('Error in Homechat:', error);
    throw error;
  }
}